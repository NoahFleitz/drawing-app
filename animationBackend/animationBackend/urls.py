"""animationBackend URL Configuration
...
"""
from AnimationStudio.views import homeView, animationStudioView, loadAnimationView
...
urlpatterns = [
    ...
    path('userAnimations/',loadAnimationView),
]
